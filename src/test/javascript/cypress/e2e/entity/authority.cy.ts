...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'af5c53a7-c106-4c14-8874-a0fe911d5e34' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('499e2f6a-098d-40b3-aa16-7594a3916094');
      cy.get(`[data-cy="name"]`).should('have.value', '499e2f6a-098d-40b3-aa16-7594a3916094');
